...
def C_confidence_interval(dta,variable):
    ...
    for i in range(len(dta)):
        if dta.ix[i][u'count_'+variable] < 30:
            t_a = t_table.ix[dta.ix[i][u'count_'+variable].astype(int)-1]['a3']
...
N_user_info2['max-min_tm_encode'] = N_user_info2['max_tm_encode'] - N_user_info2['min_tm_encode']
N_user_info2['max-mean_tm_encode'] = N_user_info2['max_tm_encode'] - N_user_info2['min_tm_encode']
N_user_info2['sum-max_tm_encode'] = N_user_info2['sum_tm_encode'] - N_user_info2['max_tm_encode']
N_user_info2['var_tm_encode'] = N_user_info2['std_tm_encode'] * N_user_info2['std_tm_encode']


N_user_info2 = C_confidence_interval(N_user_info2,'tm_encode')
...
for i in range(1,user_info1_2_2_2.shape[1]):
    if i < 4:
        ...
        N_user_info1_2_2_2[Var_N+'_sum'] = user_info1_2_2_2.groupby('user_id')[Var_N].sum()
        N_user_info1_2_2_2[Var_N+'_count'] = user_info1_2_2_2.groupby('user_id')[Var_N].count()
        N_user_info1_2_2_2['max-min'] = N_user_info1_2_2_2[Var_N+'_max'] - N_user_info1_2_2_2[Var_N+'_min']
        N_user_info1_2_2_2['max-mean'] = N_user_info1_2_2_2[Var_N+'_max'] - N_user_info1_2_2_2[Var_N+'_min']
        N_user_info1_2_2_2['sum-max'] = N_user_info1_2_2_2[Var_N+'_sum'] - N_user_info1_2_2_2[Var_N+'_max']
        N_user_info1_2_2_2['var_tm_encode'] = N_user_info1_2_2_2[Var_N+'_std'] * N_user_info1_2_2_2[Var_N+'_std']
    if i > 3:
        Var_N = user_info1_2_2_2.columns[i]
...
N_train_user_info.to_csv('dta\\Generate_dta\\N_train_user_info2.csv',index=False)
N_test_user_info.to_csv('dta\\Generate_dta\\N_test_user_info2.csv',index=False)
