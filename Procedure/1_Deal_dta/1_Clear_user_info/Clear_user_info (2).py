...
for i in range(1,user_info1_2_1.shape[1]):
    ...
    N_user_info1_2_1[Var_N] = user_info1_2_1.groupby('user_id')[Var_N].max()
...
N_train_user_info.to_csv('dta\\Generate_dta\\N_train_user_info3.csv',index=False)
N_test_user_info.to_csv('dta\\Generate_dta\\N_test_user_info3.csv',index=False)
